...
public abstract class Part implements Serializable {
    ...
    public boolean getInvError() {return this.invError;}

    public String getInvMessage() {return this.invMessage;}

    public void isInvValid() {
        if(this.inv < this.minInv) {
            this.invError = true;
            this.invMessage = "Inventory cannot be less than minimum";
        }
        else if (this.inv > this.maxInv) {
            this.invError = true;
            this.invMessage = "Inventory cannot be greater than maximum";
        }
        else {
            this.invError = false;
            this.invMessage = "";
